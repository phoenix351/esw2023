...
function hapusRtSubmit(id, token) {
    $.ajax({
        url: "/ews2023/public" + `ruta/delete`,
        type: "DELETE",
        dataType: "json",
        data: { id: id },
        headers: {
...
function editRt(element) {
    ...
    $.ajax({
        url: "/ews2023/public/" + `getRtById/${data.id}`,
        type: "GET",
        dataType: "json",
...
function simpanPengelola(e) {
    ...
    data["id"] = id;
    $.ajax({
        url: "/ews2023/public" + "/simpanPengelola",
        type: "POST",
        dataType: "json",
        data: data,
        success: function (data) {
...
function generateLink({ url, label, active, namaFungsi = "loadRt" }) {
    return active
...
function tambahUsaha(bodyTableId, fungsiHapus, jenis, data) {
    // console.log(data);
    const dataDefault = {
        a: {
...
function simpanTernak(jenis, token) {
    //show loading
...
function hapusTernak(element, jenis) {
...
function hapusTernakSubmit(indeks, token, jenis) {
    // show loading
    ...
    if (indeks > 0) {
        $.ajax({
            url: "/ews2023/public/" + `${jenisX}/delete`,
            type: "DELETE",
            dataType: "json",
            data: { id: indeks },
            headers: {
...
function hapusPengelola(indeks, token) {
    // show loading

    // delete in db is any
    if (indeks > 0) {
        $.ajax({
            url: "/ews2023/public" + "/pengelola/delete",
            type: "DELETE",
            dataType: "json",
            data: { id: indeks },
            headers: {
...
function hapusLahanSubmit(indeks, token) {
    // show loading

    // delete in db is any
    if (indeks > 0) {
        $.ajax({
            url: "/ews2023/public" + "/lahan/delete",
            type: "DELETE",
            dataType: "json",
            data: { id: indeks },
            headers: {
...
function editPengelola(indeks) {
    ...
    $.ajax({
        url: "/ews2023/public" + urlPengelola,
        type: "GET",
        dataType: "json",
        success: function (data) {
            console.log(data);
...
function setFormValue(idForm, data) {
    const formInputs = $(`#${idForm} input`);
